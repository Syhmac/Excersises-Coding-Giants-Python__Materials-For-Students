...
## Wyzwanie: Dodaj zmienną czy_rysowac (typ bool). Kliknięcie przycisku p powinno zmieniać
# jej wartość (True/False), co decyduje, czy żółw zostawia ślad (pendown/penup).